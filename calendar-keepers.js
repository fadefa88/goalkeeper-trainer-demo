...
style.textContent = `
.physical-main-card{display:grid!important;gap:16px!important}.physical-save-meta{display:grid;gap:10px;padding:14px;border-radius:12px;border:1px solid var(--line);background:var(--panel-2)}.physical-save-meta label{display:grid;gap:8px;font-weight:600}.physical-save-meta .small-note{margin:0}
.physical-progress-card{display:grid;gap:14px;margin-top:14px}.physical-chart-controls{display:grid;grid-template-columns:1fr 1fr;gap:10px}.physical-kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}
.physical-chart-box{min-height:220px;padding:14px;border:1px solid var(--line);border-radius:12px;background:var(--panel-2);overflow:hidden}.physical-chart-svg{width:100%;height:auto;display:block}.physical-axis{stroke:var(--line);stroke-width:1}.physical-grid-line{stroke:rgba(255,255,255,.06);stroke-width:1}.physical-chart-line{fill:none;stroke:var(--red);stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.physical-chart-fill{fill:var(--red-soft)}.physical-chart-dot{fill:var(--panel);stroke:var(--red);stroke-width:3}.physical-chart-label{font-size:11px;fill:var(--muted);font-weight:500}.physical-chart-value{font-size:12px;fill:var(--text);font-weight:600}.physical-empty{min-height:180px;display:grid;place-items:center;text-align:center;color:var(--muted);padding:16px}
.physical-history-list{display:grid;gap:8px}.physical-history-item{display:grid;gap:6px;padding:12px;border:1px solid var(--line);border-radius:12px;background:var(--panel-2)}.physical-history-item h4{margin:0;font-size:14px;font-weight:600}.physical-history-item p{margin:0;color:var(--muted);font-size:12px}.physical-history-tags{display:flex;flex-wrap:wrap;gap:6px}.physical-history-tags span{border:1px solid var(--line);border-radius:999px;padding:4px 8px;font-size:11px;color:var(--muted)}
.keeper-attendance-card{display:grid;gap:10px;padding:14px;border-radius:12px;border:1px solid var(--line);background:var(--panel-2);margin-top:12px}
...
.match-team{font-size:15px;font-weight:600;line-height:1.15}.match-team.away{text-align:right}.match-score{font-size:24px;font-weight:700;font-variant-numeric:tabular-nums;white-space:nowrap}
.match-meta-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.match-meta{padding:10px 12px;border-radius:10px;border:1px solid var(--line);background:var(--panel-2)}.match-meta span{display:block;color:var(--muted);font-size:10px;text-transform:uppercase;font-weight:600}.match-meta strong{display:block;margin-top:3px;font-size:13px;font-weight:600}
.match-report{display:grid;gap:10px;padding-top:2px}.match-report-grid{display:grid;grid-template-columns:minmax(0,1fr) 110px;gap:10px}.match-report textarea{min-height:88px;resize:vertical}.match-save-status{min-height:18px;color:var(--muted);font-size:12px;font-weight:600}
.match-save-status.ok{color:var(--text)}.match-save-status.error{color:#ffb4b4}
...
@media(max-width:430px){.match-meta-grid,.match-report-grid{grid-template-columns:1fr}.match-scoreboard{grid-template-columns:1fr auto 1fr;gap:8px}.match-team{font-size:14px}.match-score{font-size:22px}}
`;
...
card.innerHTML = `<div class="keeper-attendance-head"><h3>Portieri presenti</h3><span class="pill">${keepers.length} in rosa</span></div>${keepers.length ? `<div class="keeper-attendance-list">${keepers.map((keeper, index) => {
const key = keeperKey(keeper, index);
