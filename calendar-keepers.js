...
.physical-chart-box{min-height:220px;padding:14px;border:1px solid var(--line);border-radius:12px;background:var(--panel-2);overflow:hidden}.physical-chart-svg{width:100%;height:auto;display:block}.physical-axis{stroke:var(--line);stroke-width:1}.physical-grid-line{stroke:var(--line);stroke-width:1}.physical-chart-line{fill:none;stroke:var(--red);stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.physical-chart-fill{fill:var(--red-soft)}.physical-chart-dot{fill:var(--panel);stroke:var(--red);stroke-width:3}.physical-chart-label{font-size:11px;fill:var(--muted);font-weight:500}.physical-chart-value{font-size:12px;fill:var(--text);font-weight:600}.physical-empty{min-height:180px;display:grid;place-items:center;text-align:center;color:var(--muted);padding:16px}
...
.match-save-status.ok{color:var(--text)}.match-save-status.error{color:var(--red-bright)}
