const CACHE_NAME = "gk-trainer-cloudflare-d1-landing-home-image-v1";
const ASSETS = [
  "./",
  "./index.html",
  "./privacy.html",
...
;(() => {
  ...
  function ensureLandingStyles() {
    ...
    style.textContent = [
      ...
      ".landing-hero{position:relative;min-height:365px;border-radius:26px;overflow:hidden;border:1px solid rgba(213,255,222,.14);background:linear-gradient(180deg,rgba(7,17,11,.04),rgba(7,17,11,.34) 50%,rgba(3,9,6,.88)),url('/gk-home-hero.png') center/cover no-repeat;box-shadow:inset 0 -80px 110px rgba(0,0,0,.58),0 18px 45px rgba(0,0,0,.22)}",
      ".landing-hero:before{content:\"\";position:absolute;inset:0;background:radial-gradient(circle at 50% 18%,rgba(32,224,108,.12),transparent 34%),linear-gradient(180deg,transparent 60%,rgba(7,17,11,.62));pointer-events:none}",
      ".landing-hero:after{content:\"\";position:absolute;left:18px;right:18px;bottom:16px;height:1px;background:linear-gradient(90deg,transparent,rgba(32,224,108,.75),transparent);box-shadow:0 0 24px rgba(32,224,108,.55);pointer-events:none}",
