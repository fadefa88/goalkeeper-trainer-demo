...
// custom exercise. Usato da exercise-diagram.js (output grezzo del modello
// Workers AI). Il modello produce solo dati: nessun HTML/SVG/JS arriva mai
// da qui — il disegno (con le animazioni vere) lo fa renderDiagramScene()
// in app.js, deterministico, a partire da questa scena già validata.
...
// Hash della descrizione usato per rilevare "la descrizione è cambiata da
// quando ho generato lo schema" (diagram_source_hash). Controparte
// client-side identica in cloudflare-client.js (hashDiagramSource), non
